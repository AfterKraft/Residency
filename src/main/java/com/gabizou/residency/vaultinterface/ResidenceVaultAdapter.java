package com.gabizou.residency.vaultinterface;

import com.gabizou.residency.economy.EconomyInterface;
import com.gabizou.residency.permissions.PermissionsInterface;
...
public class ResidenceVaultAdapter implements EconomyInterface, PermissionsInterface {
    ...
    private static boolean setupPermissions(Server s) {
        RegisteredServiceProvider<Permission>
            permissionProvider =
            s.getServicesManager().getRegistration(net.milkbowl.vault.permission.Permission.class);
