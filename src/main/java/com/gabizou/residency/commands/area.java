...
public class area implements cmd {
    ...
    public void getLocale(ConfigReader c, String path) {
        ...
        Residence.getInstance().getLocaleManager().CommandTab
            .put(Arrays.asList(this.getClass().getSimpleName(), "listall"), Arrays.asList("[residence]"));
        ...
        Residence.getInstance().getLocaleManager().CommandTab
            .put(Arrays.asList(this.getClass().getSimpleName(), "add"), Arrays.asList("[residence]"));
        ...
        Residence.getInstance().getLocaleManager().CommandTab
            .put(Arrays.asList(this.getClass().getSimpleName(), "remove"), Arrays.asList("[residence]"));
        ...
        Residence.getInstance().getLocaleManager().CommandTab
            .put(Arrays.asList(this.getClass().getSimpleName(), "replace"), Arrays.asList("[residence]"));
